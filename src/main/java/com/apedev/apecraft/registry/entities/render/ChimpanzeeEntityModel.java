...
import com.apedev.apecraft.registry.entities.ChimpanzeeEntity;
...
public class ChimpanzeeEntityModel extends EntityModel<ChimpanzeeEntity> {
	...
	public ChimpanzeeEntityModel(ModelPart root) {
...
public void setRotationAngle(ModelPart bone, float x, float y, float z) {
	...
	@Override
	public void setAngles(ChimpanzeeEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
