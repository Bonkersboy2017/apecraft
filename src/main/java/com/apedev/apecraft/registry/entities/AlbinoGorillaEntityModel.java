...
import net.minecraft.client.util.math.MatrixStack;
	...
	public class AlbinoGorillaEntityModel extends EntityModel<AlbinoGorillaEntity> {
...
public AlbinoGorillaEntityModel(ModelPart root) {
...
public void setRotationAngle(ModelPart bone, float x, float y, float z) {
		...
		@Override
		public void setAngles(AlbinoGorillaEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
