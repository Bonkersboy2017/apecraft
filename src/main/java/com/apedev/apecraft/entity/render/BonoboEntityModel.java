...
public class BonoboEntityModel extends HierarchicalModel<BonoboEntity> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        modelPartData.addOrReplaceChild("Leftleg", CubeListBuilder.create().texOffs(12, 36).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F), PartPose.offset(-2.0F, 12.0F, 0.0F));
        PartDefinition modelPartData1 = modelPartData.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(23, 0).addBox(-3.0F, -5.0F, -5.0F, 7.0F, 2.0F, 3.0F), PartPose.offset(0.0F, 6.0F, 1.0F));
        ...
        modelPartData1.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -22.0F, 2.0F, 9.0F, 4.0F, 5.0F).texOffs(24, 5).addBox(-3.0F, -15.0F, 3.0F, 9.0F, 4.0F, 4.0F), PartPose.offset(-1.0F, 18.0F, -3.0F));
        ...
        modelPartData.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(21, 16).addBox(0.0F, 0.0F, 2.0F, 3.0F, 14.0F, 4.0F), PartPose.offset(5.0F, 2.0F, -6.0F));
        PartDefinition modelPartData2 = modelPartData.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 8).addBox(-4.0F, -6.0F, -3.0F, 7.0F, 6.0F, 6.0F).texOffs(0, 8).addBox(-4.0F, -6.0F, 3.0F, 7.0F, 2.0F, 0.0F, true), PartPose.offset(1.0F, 1.0F, -3.0F));
        ...
        modelPartData.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(31, 31).addBox(-2.0F, 1.0F, -2.0F, 4.0F, 12.0F, 4.0F), PartPose.offset(3.0F, 11.0F, 0.0F));
        modelPartData.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(0, 21).addBox(-3.0F, 0.0F, -2.0F, 3.0F, 13.0F, 4.0F), PartPose.offset(-4.0F, 2.0F, -2.0F));
        return LayerDefinition.create(modelData, 64, 64);
    }

    @Override
    public void setupAnim(BonoboEntity entity, float limbAngle, float limbDistance, float animationProgress, float netHeadYaw, float headPitch) {
